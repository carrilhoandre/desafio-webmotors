...
{
    public class CriarAnuncioValidatorTests
    {
        CriarAnuncioValidator _validator = null;
        CriarAnuncioCommand command = new CriarAnuncioCommand()
        {
            Marca = "Ford",
            Modelo = "Fussion",
        ...
        public CriarAnuncioValidatorTests()
        {
            _validator = new CriarAnuncioValidator();
        }
        ...
        public void Sut_Validator()
        {
            _validator
                .Should()
                .BeAssignableTo<AbstractValidator<CriarAnuncioCommand>>();
        }
